 ...
 */
public class Tela_Do_Enfermeiro extends javax.swing.JFrame {

    /**
     * Creates new form Tela_Principal
     */
    public Tela_Do_Enfermeiro() {
        initComponents();
    }
    ...
    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
        ...
        Tela_Enfermeiro_Alterar_Dados tea = new Tela_Enfermeiro_Alterar_Dados();
        tea.setVisible(true);
        Desktop.add(tea);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Do_Enfermeiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Do_Enfermeiro().setVisible(true);
            }
        });
    }
